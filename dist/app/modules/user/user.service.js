...
const createStudent = (student, user) => __awaiter(void 0, void 0, void 0, function* () {
    ...
    // Set role
    user.role = 'student';
    const academicSemesters = yield academicSemester_model_1.default.findById(student.academicSemester);
    // Generate student id
    let newUserAllData = null;
    const session = yield mongoose_1.default.startSession();
    try {
        session.startTransaction();
        const id = yield (0, user_utils_1.generateStudentId)(academicSemesters);
        user.id = id;
        student.id = id;
